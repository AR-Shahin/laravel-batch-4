            ...
            <div class="row">
                ...
                <div class="col-12 col-md-3">
                    <div class="form-group">
                      ...
                      <select name="sub_category_id" id="sub_cat_id" class="form-control">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-gorup">
                        ...
                        <textarea name="description" id="description" class="form-control" cols="30" rows="10" placeholder="Enter a short descripton in your psot"></textarea>
                        @error('description')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
