            ...
            <tbody>
                @foreach ($posts as $post)
                    <tr>
                        ...
                        <a href="{{ route('admin.post.show',$post->id) }}" class="btn btn-sm btn-success"><i class="fa fa-eye"></i></a>
                            <a href="{{ route('admin.post.edit', $post->id) }}" class="btn btn-sm btn-info"><i class="fa fa-edit"></i></a> 

                           <form action="{{ route('admin.post.destroy', $post->id) }}" class="d-inline" method="POST">
                            @csrf
                            @method('DELETE')
